...
#define MINGOOD 50
//delete stored getworks older than this, changed from 60s to 30s
#define MAXWORKAGE 30
...
// maximum number of bad chips to clock board down to MINSPEED
#define MAXBAD 5
// minimum nonce rate to clock board down to MINSPEED
#define MINNR 0.1
// minimum nonce rate to reprogram chips
#define FIXNR 1.0
// target nonce rate for optimizer
#define DEFNR 2.0
// max errors/nonces to stop rate increase [0.1]
#define MAXBERROR 0.2
